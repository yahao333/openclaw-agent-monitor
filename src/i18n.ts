...
export const t = {
  en: {
    ...
    grid: "Grid",
    list: "List",
    footer: "github.com/yahao333/openclaw-status-monitor · Contact: X @pai12468",
    ...
    offlineThresholdHint: "Agent offline if no heartbeat after this duration",
    minutes: "min",
    token: "Agent Token",
  ...
  zh: {
    ...
    grid: "网格",
    list: "列表",
    footer: "github.com/yahao333/openclaw-status-monitor · 联系方式：X @pai12468",
    ...
    offlineThresholdHint: "Agent 上报中断超过此时间视为离线",
    minutes: "分钟",
    token: "Agent Token",
