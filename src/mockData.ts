...
export const MOCK_AGENTS: Agent[] = [
  ...
  },
  {
    ...
    status: 'online',
    role: { en: 'System Monitor', zh: '系统监控' },
    lastActive: { en: 'Just now', zh: '刚刚' },
  ...
  },
  {
    ...
    status: 'offline',
    role: { en: 'Backup Scraper', zh: '备用抓取' },
